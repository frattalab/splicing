...
option_list = list(
    make_option(c("-g", "--gtf"), type="character", default=NULL,
                help="A gtf file produced by Scallop", metavar="character"),
    make_option(c("-ot", "--outtranscripts"), type="character", default="out.txt",
                help="output of a list of transcript names containing cryptic events", metavar="character"),
    make_option(c("-ob", "--outbed"), type="character", default="out.txt",
                help="output of a bed file of the coordinates of the cryptic exons", metavar="character"),
